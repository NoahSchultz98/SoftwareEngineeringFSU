...
public class NoahActivity_MyTextWatcher
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Codeholic.NoahActivity+MyTextWatcher, Codeholic", NoahActivity_MyTextWatcher.class, __md_methods);
	}


	public NoahActivity_MyTextWatcher ()
	{
		super ();
		if (getClass () == NoahActivity_MyTextWatcher.class) {
			mono.android.TypeManager.Activate ("Codeholic.NoahActivity+MyTextWatcher, Codeholic", "", this, new java.lang.Object[] {  });
		}
	}

	public NoahActivity_MyTextWatcher (crc647393a3d6bb91a4eb.NoahActivity p0)
	{
		super ();
		if (getClass () == NoahActivity_MyTextWatcher.class) {
			mono.android.TypeManager.Activate ("Codeholic.NoahActivity+MyTextWatcher, Codeholic", "Codeholic.NoahActivity, Codeholic", this, new java.lang.Object[] { p0 });
		}
	}
