    ...
    public class PluginManagerActivity : Activity
    {
        ...
        */
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //Toast.MakeText(Android.App.Application.Context, "current user: " + DatabaseConnection.currentUser.userID + "current user type: " + DatabaseConnection.currentUser.userType, ToastLength.Long).Show();
            ListPlugins(plugins);
